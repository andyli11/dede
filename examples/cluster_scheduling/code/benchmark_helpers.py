...
def get_args(formatted_fname_template):
    ...
    parser.add_argument(
        ...
        type=str,
        default="none",
        choices=["none", "input", "x_update", "z_update", "y_update", "output"],
        help="where to inject DP Gaussian noise in DeDe",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="stddev of Gaussian noise for DP",
    )
